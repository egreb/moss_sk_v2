...
(function () {
  ...
  if (ingress) {
    new easymde__WEBPACK_IMPORTED_MODULE_1___default.a(_objectSpread({
      element: ingress,
  ...
  if (content) {
    new easymde__WEBPACK_IMPORTED_MODULE_1___default.a(_objectSpread({
      ...
      toolbar: ["bold", "italic", "heading", "|", "quote", "|", "ordered-list", "unordered-list", "|", {
        name: "gallery",
...
function toggleGallery(editor) {
  var content, modal_content, result, data;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function toggleGallery$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          toggleModal();
          content = document.getElementById('content'); // textarea
        ...
        case 4:
          modal_content = document.querySelector('.modal-body');

          if (!(!document.body.classList.contains('modal-active') || modal_content.innerHTML !== '')) {
            _context.next = 7;
            break;
          }
        ...
        case 7:
          _context.prev = 7;
          _context.next = 10;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch('/api/image', {}));
        ...
        case 13:
          ...
          if (data.success) {
            Object.values(data.data).forEach(function (image) {
              var imageContainer = document.createElement('a');
              imageContainer.className = 'relative w-1/3';
              imageContainer.innerHTML = "\n                    <img class=\"\" src=\"".concat(image.url, "\" alt=\"").concat(image.name, "\" style=\"\">\n                ");
              imageContainer.addEventListener('click', function (event) {
                toggleModal();
                var newText = "![".concat(image.name, "](").concat(image.url, ")");
        ...
        case 17:
          ...
          console.error('fetching images', _context.t0);
...
function insertAtCursor(input, textToInsert) {
  var isSuccess = document.execCommand("insertText", false, textToInsert); // Firefox (non-standard method)

  if (!isSuccess && typeof input.setRangeText === "function") {
    var start = input.selectionStart;
    input.setRangeText(textToInsert); // update cursor to be at the end of insertion

    input.selectionStart = input.selectionEnd = start + textToInsert.length; // Notify any possible listeners of the change
