...
(function () {
  ...
  if (ingress) {
    var e = new easymde__WEBPACK_IMPORTED_MODULE_0___default.a(_objectSpread({
      element: ingress,
  ...
  if (content) {
    new easymde__WEBPACK_IMPORTED_MODULE_0___default.a(_objectSpread({
      element: content,
...
function createEvent() {
  ...
  title.innerHTML = "".concat(event.title);
  var date = document.createElement("div");
  date.classList.add("w-1/4");
  date.innerHTML = "".concat(event.date);
