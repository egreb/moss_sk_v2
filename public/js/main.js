...
document.addEventListener("DOMContentLoaded", function (event) {
  var top_level_menu = document.querySelectorAll('a[href="#toggle-menu"], li.toggle-menu:not(.menu-item)');
  top_level_menu.forEach(function (item) {
    item.addEventListener("click", function (event) {
      ...
      if (menu.classList.contains("hidden")) {
        var already_active = document.querySelector(".submenu:not(.hidden)");
...
module.exports = __webpack_require__(/*! /Users/sib/dev/sjakknet/resources/js/main.js */"./resources/js/main.js");
