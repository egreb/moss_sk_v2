...
<ul class="flex flex-col rounded relative lg:absolute hidden submenu">
    ...
    <li class="menu-item toggle-menu lg:bg-gray-800 lg:pt-4 lg:pb-2 lg:px-4 relative w-full lg:mr-0">
        <div class="flex items-center w-full justify-end lg:justify-center pr-2 lg:pr-0 cursor-pointer">
        ...
        <ul class="flex flex-col w-full items-end hidden mx-1">
            ...
            <a href="{{ $tournament->url }}" class="menu-item mr-4 lg:mr-0 lg:text-center" onclick="event.stopPropagation()" target="_blank">
                {{ $tournament->title }}
            </a>
            @endforeach
        </ul>
