...
@section('content')
	<h2 class="text-gray-800 text-3xl">Informasjon</h2>
	...
	<section class="bg-2">
		...
		<ul class="member-categories">
			<li class="flex flex-wrap border-gray-800 border-b">
				...
				<div class="flex items-center w-1/4 bg-gray-400 p-4 text-gray-800">1650 kr</div></li>
			<li class="flex flex-wrap border-gray-800 border-b">
				<div class="flex items-center w-3/4 p-4 bg-gray-200">Pensjonist / trygdet inkl. startavgifter</div>
				<div class="flex items-center w-1/4 bg-gray-400 p-4 text-gray-800">1350 kr</div></li>
			<li class="flex flex-wrap border-gray-800 border-b">
				<div class="flex items-center w-3/4 p-4 bg-gray-200">Junior under 21 år inkl. startavgifter</div>
				<div class="flex items-center w-1/4 bg-gray-400 p-4 text-gray-800">900 kr</div></li>
			<li class="flex flex-wrap border-gray-800 border-b">
	...
	<section class="bg-2 mt-2">
		...
		<ul class="member-categories">
			<li class="flex flex-wrap border-gray-800 border-b">
				<div class="flex items-center w-3/4 p-4 bg-gray-200">Klubbmesterskap Langsjakk <br /> Hurtig <br /> Lyn</div>
				<div class="flex items-center w-1/4 bg-gray-400 p-4 text-gray-800"> 250 kr <br /> 200 kr <br /> 150 kr</div>
			</li>
			<li class="flex flex-wrap border-gray-800 border-b">
				<div class="flex items-center w-3/4 p-4 bg-gray-200">Høstmesterskap langsjakk</div>
				<div class="flex items-center w-1/4 bg-gray-400 p-4 text-gray-800">250 kr </div></li>
			</li>
		</ul>
	</section>
	...
	<section class="bg-2 mt-2">
		...
		<ul class="member-categories">
			...
			<li class="flex flex-wrap border-gray-800 border-b">
				...
				<div class="flex items-center w-8/12 p-4"><a href="mailto:post@sjakknet.no">post@sjakknet.no</a></div>
			</li>
			<li class="flex flex-wrap border-gray-800 border-b">
