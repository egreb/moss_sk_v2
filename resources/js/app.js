...
const app = createApp({})
app.component('MarkdownArea', require('./components/MarkdownArea').default)
app.component('PostImage', require('./components/PostImage').default)
app.component('RelevantLinks', require('./components/RelevantLinks').default)
