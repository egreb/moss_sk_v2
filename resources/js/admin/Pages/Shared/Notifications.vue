<template>
  <transition name="fade" appear>
    <div v-if="show" class="absolute w-screen flex justify-end bottom-10 right-10">
      <div class="w-64">
...
const show = computed(() => !state.hide && props?.flash?.message !== null)

watch(() => props, (prev, curr) => {
  if (curr?.flash?.message === null) return
